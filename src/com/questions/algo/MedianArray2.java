...
public class MedianArray2
{
    ...
    {
        MedianArray2 medianArray2 = new MedianArray2();
        List<Integer> a = Arrays.asList(-40, -25, 5, 10, 14, 28, 29, 48);
        List<Integer> b = Arrays.asList( -48, -31, -15, -6, 1, 8);
        System.out.println(medianArray2.findMedianSortedArrays(a, b));
    }
}
